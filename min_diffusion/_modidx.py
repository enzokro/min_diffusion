...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'min_diffusion.core': { 'min_diffusion.core.MinimalDiffusion': ('core.html#minimaldiffusion', 'min_diffusion/core.py'),
                                    ...
                                    'min_diffusion.core.MinimalDiffusion.get_text_embeddings': ( 'core.html#minimaldiffusion.get_text_embeddings',
                                                                                                 'min_diffusion/core.py'),
                                    'min_diffusion.core.MinimalDiffusion.load_pipeline': ( 'core.html#minimaldiffusion.load_pipeline',
                                                                                           'min_diffusion/core.py'),
                                    ...
                                    'min_diffusion.core.MinimalDiffusion.to_device': ( 'core.html#minimaldiffusion.to_device',
                                                                                       'min_diffusion/core.py')},
            'min_diffusion.utils': { 'min_diffusion.utils.image_from_latents': ('utils.html#image_from_latents', 'min_diffusion/utils.py'),
